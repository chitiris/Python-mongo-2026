...
Δημιουργήθηκε για τις ανάγκες παρουσίασης σε φοιτητές, επιδεικνύοντας πώς στήνουμε μια βάση σε Docker, πώς εισάγουμε δεδομένα μέσω γραφικού περιβάλλοντος και πώς εκτελούμε queries μέσω κώδικα.
...
2. [MongoDB Compass](https://www.mongodb.com/products/compass) (Για γραφική διαχείριση της βάσης)
...
### Βήμα 2: Σύνδεση & Εισαγωγή Δεδομένων
1. Ανοίξτε το **MongoDB Compass** και δημιουργήστε νέα σύνδεση με το παρακάτω Connection String:
   ```text
   mongodb://admin:secret@localhost:27017/
   ```
2. Δημιουργήστε μια νέα βάση δεδομένων με όνομα `LibraryExample`.
3. Δημιουργήστε δύο collections: `books` και `members`.
4. Χρησιμοποιήστε την επιλογή **Insert Document** (ή Import Data) για να προσθέσετε τα JSON δεδομένα του μαθήματος μέσα στα αντίστοιχα collections.

### Βήμα 3: Προετοιμασία Περιβάλλοντος Python (Virtual Environment)
Για να απομονώσουμε τις βιβλιοθήκες (όπως το `pymongo`), δημιουργούμε ένα εικονικό περιβάλλον.
